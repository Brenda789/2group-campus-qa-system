...
export const mockChatHistory = [
  { id: 1, question: '河海大学有几个校区？', answer: '河海大学共有三个校区：西康路校区（南京）、江宁校区（南京）和常州校区。', createTime: '2026-07-16T09:00:00' },
  { id: 2, question: '江宁校区图书馆开放时间？', answer: '江宁校区图书馆开放时间为每天 7:00-22:30，周末及节假日正常开放。', createTime: '2026-07-16T10:30:00' },
  { id: 3, question: '如何办理校园卡？', answer: '新生入学后由学校统一办理校园卡。如有遗失，可前往信息中心挂失补办，需携带身份证。', createTime: '2026-07-16T11:00:00' },
  { id: 4, question: '学校有哪些食堂？', answer: '河海大学各校区均设有多座食堂：江宁校区有第一食堂、第二食堂、第三食堂及民族餐厅。', createTime: '2026-07-16T14:20:00' },
  { id: 5, question: '怎么申请奖学金？', answer: '奖学金每学年评选一次，学生需在规定时间内提交申请表及相关材料至学院学工办。', createTime: '2026-07-16T15:45:00' },
]
